...
public class Frame extends javax.swing.JFrame {
    ...
    public void mostraMessaggio (String messaggio) {
        JOptionPane.showMessageDialog(this, messaggio, "Ricettario-Messaggio", JOptionPane.INFORMATION_MESSAGE);
    }
    
    public void mostraMessaggioErrore (String errore) {
        JOptionPane.showMessageDialog(this, errore, "Ricettario-Errore", JOptionPane.ERROR_MESSAGE);
    }
